...
export default function Reviewer_Rejceted() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 mt-10">
      <h1 className="text-2xl font-semibold mb-4">Rejected Thesis List</h1>
        ...
        <table className="min-w-full table-auto text-sm">
          ...
          <tbody>
            {paginated.length === 0 ? (
              ...
              paginated.map((item) => (
                <tr key={item._id} className="border-b bg-rose-50 hover:bg-gray-50">
