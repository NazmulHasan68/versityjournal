    ...
    <section className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link to={'/submit_research'} className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-sky-600 transition px-4 py-2 text-sm sm:text-base rounded-md font-semibold shadow-md">
            Submit Research
          </Link>
        </div>
      </div>
